class SortingRobot:
    ...
    def sort(self):
        ...
        #         # self.move_right() # start at second place
        #         # self.swap_item()
        #         #self.move_left()
        #         print(self.compare_item() == None or self.compare_item() < 0)
        ...
        ''' 
        Second pass ## after watching the video
        '''
        ...
        while self.light_is_on():
            ...
            if self.can_move_right() == False and self.compare_item() is None:
                self.swap_item()
                self.set_light_off()
                # stop sorting
            else:
